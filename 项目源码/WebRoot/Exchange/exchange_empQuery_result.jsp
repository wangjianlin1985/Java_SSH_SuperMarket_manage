...
<div id="exchange_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="exchangeQueryForm" method="post">
			...
			<input class="textbox" type="text" id="employeeObj_employeeNo_query" name="employeeObj.employeeNo" value="<%=session.getAttribute("employee") %>" style="display:none;width: auto"/>
...
<script type="text/javascript" src="Exchange/js/exchange_emp_manage.js"></script> 
