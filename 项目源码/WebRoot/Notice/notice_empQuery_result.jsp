...
<div id="notice_manage_tool" style="padding:5px;">
	<div style="margin-bottom:5px;">
		<a href="#" class="easyui-linkbutton" iconCls="icon-edit-new" plain="true" onclick="notice_manage_tool.edit();">详情</a> 
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="noticeQueryForm" method="post">
			...
			公告日期：<input type="text" id="noticeDate" name="noticeDate" class="easyui-datebox" editable="false" style="width:100px">
...
<script type="text/javascript" src="Notice/js/notice_emp_manage.js"></script> 
