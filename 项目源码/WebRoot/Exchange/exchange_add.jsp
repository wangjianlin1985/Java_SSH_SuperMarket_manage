...
<div id="exchangeAddDiv">
	<form id="exchangeAddForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="exchange_employeeObj_employeeNo" name="exchange.employeeObj.employeeNo" style="width: auto"/>
			</span>
		</div>
		<div class="operation">
...
<script src="${pageContext.request.contextPath}/Exchange/js/exchange_add.js"></script> 
