...
$(function () { 
	...
	$("#notice_manage").datagrid({
		url : 'Notice/Notice_ajaxQueryNotice.action',
		fit : true,
		fitColumns : true,
		striped : true,
		rownumbers : true,
			...
			if (rows.length > 0) {
				$.messager.confirm("确定操作", "您正在要删除所选的记录吗？", function (flag) {
					if (flag) {
						...
						$.ajax({
							type : "POST",
							url : "Notice/Notice_ajaxDeleteNotice.action",
							data : {
