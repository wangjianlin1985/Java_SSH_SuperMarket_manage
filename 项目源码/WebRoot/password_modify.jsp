...
<TABLE align="center" height="100%" cellSpacing=0 cellPadding=0 width="80%" border=0>
  ...
  <TR>
    ...
    <form action="<%=basePath %>password/ChangePassword.action" method="post" name="form1" target="submitFrame">
...
<iframe name="submitFrame" frameborder="0" scrolling="yes" width="100%" height="500px"></iframe>
   </TD>
	</TR>
  </TBODY>
</TABLE>
